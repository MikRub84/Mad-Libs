...
if n == 1:
    ...
    story1 = "\t It was about " + word1 + " ago when I arrived at the hospital in a/an " + word2 + ". " + 
"\n The hospital is a/an " + word3 + " place, there are a lot of " + word4 + " here." + 
"\n There are nurses here, who have " + word5 + "." + 
"\n If someone wants to come into my room, I told them, that they have to " + word6 + " first." + 
"\n I've decorated my room with " + word7 + "." + 
"\n Today I talked to a doctor and they were wearing a/an " + word8 + " on their " + word9 + "." + 
"\n I heard, that all doctors " + word10 + " every day for breakfast." + 
"\n The most " + word11 + " thing about being in the hospital is the " + word12 + "!"
    print('\n')
    print(story1)
...
if n == 2:
    ...
    story2 = "\t This weekend I am going camping with " + temp1 + "." + 
"\n I packed my lantern, sleeping bag and " + temp2 + "." + 
"\n I am so " + temp3 + " to " + temp4 + " in a tent." + 
"\n I am " + temp5 + " we might see a/an " + temp6 + ", I hear they're kind of dangerouse." + 
"\n While we're camping, we are going to hike, fish and " + temp7 + "." + 
"\n I have heard, that the " + temp8 + " lake is great for " + temp9 + "." + 
"\n Then we will " + temp10 +" hike through the forest for " + temp11 + "." + 
"\n If I see a/an " + temp12 + " while hiking, I am going to bring it home as a pet!" + 
"\n At night we will tell " + temp13 + " stories and roast " + temp14 + " around the campfire!!"
    print('\n')
    print(story2)
...
if n == 3:
    ...
    story3 = "\t Dear " + text1 + ", I am writing to you from a/an " + text2 + " castle in an enchanted forest." + 
"\n I found myself here one day after going for a ride on a/an " + text3 + " in " + text4 + "." + 
"\n There are " + text5 + " and " + text6 + " here!" + 
"\n In the " + text7 + " there is a pool full of " + text8 + "." + 
"\n I fall asleep each night on a/an " + text9 + " of " + text10 + " and dream of " + text11 + "." + 
"\n It feels as though I have lived here for " + text12 + "." + 
"\n I hope one day you can visit, although the only way to get here now is " + text13 + " on a/an " + text14 + "!!"
    print('\n')
    print(story3)
